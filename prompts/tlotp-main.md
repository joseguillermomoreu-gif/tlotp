...
⚔️ **🏹 Bardo** — El Contrabandista. Invoca MCPs y plugins desde los Shire Markets. *(~/.claude.json · .mcp.json · plugins/ · settings.json)*
...
```json
{
  "questions": [{
    ...
    "options": [
      ...
      {
        "label": "🏹 Bardo",
        "description": "El Contrabandista — invoca MCPs y plugins desde los Shire Markets"
      },
      {
        "label": "⚒️ Celebrimbor",
